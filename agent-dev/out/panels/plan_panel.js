...
class PlanPanel {
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(PlanPanel.viewType, 'AgentDev - Plan', vscode.ViewColumn.Beside, {
            enableScripts: true,
...
PlanPanel.viewType = 'agent-dev-plan';
//# sourceMappingURL=plan_panel.js.map