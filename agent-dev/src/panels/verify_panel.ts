...
export class VerifyPanel {
  public static currentPanel: VerifyPanel | undefined;
  public static readonly viewType = 'agent-dev-verify';
  private readonly panel: vscode.WebviewPanel;
  private disposables: vscode.Disposable[] = [];
  private currentResult: VerifyResult | null = null;

  public static createOrShow(extensionUri: vscode.Uri): VerifyPanel {
    ...
    const panel = vscode.window.createWebviewPanel(
      VerifyPanel.viewType,
      'AgentDev - Verification',
  ...
  public update(result: VerifyResult): void {
  ...
  public static revive(panel: vscode.WebviewPanel, extensionUri: vscode.Uri): VerifyPanel {
    return new VerifyPanel(panel, extensionUri);
  }
  ...
  private getHtml(result: VerifyResult | null): string {
